    ...
    return (
        <div className="flex flex-col sm:flex-row flex-wrap justify-center items-center gap-8 sm:gap-12 mb-10">
            <div className="bg-dark_purple shadow-xl border border-gray-200 rounded-xl p-5 sm:p-6 w-full sm:w-64 md:w-72 text-center transition-shadow hover:shadow-2xl">
                ...
                <p className={`${health_avg !== null ? "text-3xl sm:text-4xl md:text-5xl font-extrabold" : "text-sm font-thin text-cream"} ${health_avg !== null ? `text-${getTColor(health_avg)}` : ""}`}>
            ...
            <div className="bg-dark_purple shadow-xl border border-gray-200 rounded-xl p-5 sm:p-6 w-full sm:w-64 md:w-72 text-center transition-shadow hover:shadow-2xl">
                ...
                <p className={`${prod_avg !== null ? "text-3xl sm:text-4xl md:text-5xl font-extrabold" : "text-sm font-thin text-cream"} ${prod_avg !== null ? `text-${getTColor(prod_avg)}` : ""}`}>
